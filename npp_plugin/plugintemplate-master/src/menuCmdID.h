...
#define IDM_TRANSLATE    (IDM + 3200)
#define  IDM_TRANSLATE_SELECTION   	(IDM_TRANSLATE + 1)
#define  ID_TRANSLATE_SELECTION   	(IDM_TRANSLATE + 2)
#define     IDM_QUERY_PHONETICS     (IDM_TRANSLATE + 3)
